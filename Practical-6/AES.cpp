...
// Roll No: 34
// Sec: A
// Practical 6 AES-128 bit key expansion

#include<bits/stdc++.h>
using namespace std; 
// typedef :- used to create an additional name for another data type 
// bitset :- it is a container used for dealing with data at bit level
...
word Rcon[10] = {0x01000000, 0x02000000, 0x04000000, 0x08000000, 0x10000000,   
    ...
    {  
            // to_ulong :- used to convert the contents of the bitset to an unsigned long integer
