...
public class SHA1{
    ...
    public static void main(String[] args) {
        ...
        //Getting the word
        System.out.println("\tName : Anish Tilloo");
        System.out.println("\tRoll No : 34   Sec : A");
        System.out.println("\tPractical No : 07");
        // System.out.println("\tAim : Implement SHA-1 Hashing function");
        System.out.print("\tEnter a word to convert it into hash");
    ...
    private static String hash(int[] z) {
        ...
        System.out.println("Hashed code: " + hh);
...
// 			byte[] testdata = new byte[28];
// 			byte[] digest = md.digest(testdata);

// 			System.out.println("Anish Tilloo\nRoll No. 34\nSection A\nBatch A2\nAim - To implement SHA-1.\n");
